var serviceNames = require("../core/config-manager.js").getConfig("services");
var services = {};
...
exports.init = function (app, express) {
	for(var serviceIdx in serviceNames){
		var serviceName = serviceNames[serviceIdx];
		services[serviceName] = require('../services/'+serviceName+'.js'),
		services[serviceName].init(app, express);
	}
}
